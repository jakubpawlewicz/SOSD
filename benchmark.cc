...
void execute_32_bit(Benchmark benchmark, bool pareto, bool only_mode,
  ...
  check_only("FastMapRegBucketSingle", benchmark_32_fastmap_regbucket_single(benchmark, pareto));
...
void execute_64_bit(Benchmark benchmark, bool pareto, bool only_mode,
  ...
  check_only("FastMapRegBucketSingle", benchmark_64_fastmap_regbucket_single(benchmark, pareto));
