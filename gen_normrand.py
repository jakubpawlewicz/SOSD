...
print("Generating normal random data...")
if not os.path.exists("data/normal_rand_200M_uint32"):
    print("32 bit...")
    keys = np.random.random_sample((NUM_KEYS,))
    keys.sort()
    ...
    with open("data/normal_rand_200M_uint32", "wb") as f:
        f.write(struct.pack("Q", len(keys)))
        keys.tofile(f)

if not os.path.exists("data/normal_rand_200M_uint64"):
    print("64 bit...")
    keys = np.random.random_sample((NUM_KEYS,))
    keys.sort()
    ...
    with open("data/normal_rand_200M_uint64", "wb") as f:
        f.write(struct.pack("Q", len(keys)))
        keys.tofile(f)

print("Generating log normal random data...")
if not os.path.exists("data/lognormal_rand_200M_uint32"):
    print("32 bit...")
    keys = np.random.random_sample((NUM_KEYS,))
    keys.sort()
    ...
    with open("data/lognormal_rand_200M_uint32", "wb") as f:
        f.write(struct.pack("Q", len(keys)))
        keys.tofile(f)

if not os.path.exists("data/lognormal_rand_200M_uint64"):
    print("64 bit...")
    keys = np.random.random_sample((NUM_KEYS,))
    keys.sort()
    ...
    with open("data/lognormal_rand_200M_uint64", "wb") as f:
        f.write(struct.pack("Q", len(keys)))
        keys.tofile(f)
